...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)//初始化
{
	...
	Main.CreateFrame(345, 240, 235, 180, 0, L" 极域版本 ");
	...
	Main.CreateCheck(365, 265, 0, 100, L"2016版");
	Main.CreateCheck(365, 295, 0, 100, L"2015版(不可用)");
	Main.CreateCheck(365, 325, 0, 100, L"2012版(不可用)");
	Main.CreateCheck(365, 355, 0, 100, L"2010版(不可用)");
	Main.CreateCheck(365, 385, 0, 100, L"2007版(不可用)");
